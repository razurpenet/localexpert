...
const CATEGORIES = [
  ...
  { slug: 'african-hair-braiding', name: 'Braiding', icon: 'cut' as const, color: '#EC4899' },
  { slug: 'afro-caribbean-catering', name: 'Catering', icon: 'restaurant' as const, color: '#F97316' },
  { slug: 'gardening', name: 'Gardening', icon: 'leaf' as const, color: '#22C55E' },
  { slug: 'celebration-cakes', name: 'Cakes', icon: 'cafe' as const, color: '#F472B6' },
  { slug: 'african-tailoring', name: 'Tailoring', icon: 'shirt' as const, color: '#A855F7' },
  ...
  { slug: 'event-decoration', name: 'Decor', icon: 'ribbon' as const, color: '#D946EF' },
  { slug: 'makeup-artist', name: 'Makeup', icon: 'brush' as const, color: '#E11D48' },
